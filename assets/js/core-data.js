...
const BrewscapeData = {
    ...
    seedData: {
        ...
        orders: [
            { id: "ORD-9926", userId: "U1001", date: "2026-04-28 22:33:09", total: 151.75, status: "Pending", itemsCount: 2, address: "123 Coffee Lane, Brew City", items: [{ productId: 101, quantity: 2, price: 5.00 }, { productId: 102, quantity: 1, price: 6.50 }] },
            { id: "ORD-4f65", userId: "U1001", date: "2026-04-28 11:33:00", total: 3.75, status: "Completed", itemsCount: 1, address: "123 Coffee Lane, Brew City", items: [{ productId: 104, quantity: 1, price: 3.75 }] },
            { id: "ORD-f305", userId: "U1001", date: "2026-04-27 15:20:00", total: 19.35, status: "Pending", itemsCount: 2, address: "123 Coffee Lane, Brew City", items: [{ productId: 101, quantity: 1, price: 5.00 }, { productId: 106, quantity: 2, price: 7.50 }] },
            { id: "ORD-af09", userId: "U1002", date: "2026-04-02 09:30:00", total: 12.75, status: "Completed", itemsCount: 2, address: "456 Main St, Demo Town", items: [{ productId: 102, quantity: 1, price: 6.50 }, { productId: 103, quantity: 1, price: 3.95 }] },
            { id: "ORD-af0b", userId: "U1002", date: "2026-04-02 10:15:00", total: 15.00, status: "Completed", itemsCount: 1, address: "456 Main St, Demo Town", items: [{ productId: 106, quantity: 2, price: 7.50 }] }
        ],
        favorites: [
